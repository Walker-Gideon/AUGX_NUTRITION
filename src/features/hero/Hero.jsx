...
export default function Hero() {
  return (
    <Container section="hero" classname={"relative w-full min-h-screen bg-gradient-to-br from-white via-primary/10 to-primary flex flex-col justify-center"}>
      <Main classname={"w-full px-4 md:px-10 lg:px-16 py-32 md:py-38"}>
        <Flex jsText="between" cText="center" classname={"flex-col large:flex-row text-center large:text-left gap-12"}>
          ...
          <Group classname={"w-full large:w-auto flex-shrink-0"}>
            ...
            <Group classname={"border w-full h-64 large:w-90 large:h-100 lg:w-120 rounded-xl"}></Group>
          </Group>
        </Flex>
      </Main>
    </Container>
